...
import 'package:setting_table/model/updateChannel.dart';
...
//  Stream<DocumentSnapshot> eg1 = Firestore.instance.document('E.G 1').snapshots();

  crudMethods crudObj = new crudMethods();
  QuerySnapshot channelFromStore;
...
//                ),
              ...
              centerTitle: true,
              title: Text('채널표', style: TextStyle(
...
//                    color: Colors.white,
                          child: Card(
                              ...
                              child: currentChannel.isEmpty
                                  ...
                                  width: 50, height: 30)
                                  : Center(child: Text(currentChannel,
